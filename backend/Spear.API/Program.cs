...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Spear Crash Game API",
        Version = "v1",
        Description = "Backend API for the Spear crash game — handles auth, game rounds, bets, wallet, and real-time events via SignalR."
    });
